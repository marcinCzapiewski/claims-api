...
public class ClaimTests
{
    ...
    {
        var cover = Cover.LoadFromDatabase("cover_id", DateTime.UtcNow.AddDays(-100), DateTime.UtcNow.AddDays(100), CoverType.Yacht, 2.00m);
    ...
    {
        var cover = Cover.LoadFromDatabase("cover_id", DateTime.UtcNow.AddDays(-200), DateTime.UtcNow.AddDays(-100), CoverType.Yacht, 2.00m);
    ...
    {
        var cover = Cover.LoadFromDatabase("cover_id", DateTime.UtcNow.AddDays(100), DateTime.UtcNow.AddDays(200), CoverType.Yacht, 2.00m);
    ...
    {
        var cover = Cover.LoadFromDatabase("cover_id", DateTime.Parse("2015-01-02"), DateTime.Parse("2016-01-02"), CoverType.Yacht, 2.00m);
