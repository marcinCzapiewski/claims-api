...
public class DomainError(string code, string message) : IEquatable<DomainError>
{
    ...
    public override bool Equals(object? obj) => obj is DomainError error && Equals(error);
